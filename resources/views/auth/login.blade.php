...
<head>
    ...
    <title>AsesorAutos | Log in</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- Font Awesome -->
    <link rel="stylesheet" href="/public/assets/lte3/plugins/fontawesome-free/css/all.min.cs'">
    <!-- Ionicons -->
...
<body class="hold-transition login-page">
    ...
    <!-- AdminLTE App -->
    <script src="/public/assets/lte3/dist/js/adminlte.min.js"></script>
